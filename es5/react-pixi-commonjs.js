...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pixi = __webpack_require__(77);

	var _pixi2 = _interopRequireDefault(_pixi);

	var _ReactMultiChild = __webpack_require__(78);

	var _ReactMultiChild2 = _interopRequireDefault(_ReactMultiChild);

	var _ReactElement = __webpack_require__(79);

	var _ReactElement2 = _interopRequireDefault(_ReactElement);

	var _ReactUpdates = __webpack_require__(80);
	...
	var _emptyObject = __webpack_require__(82);
	...
	var _ReactPIXIMonkeyPatch = __webpack_require__(86);
	...
	var gStandardProps = {
	  ...
	  mask: null,
	  // can't set parent!
	  pivot: new _pixi2.default.Point(0, 0),
	  // position has special behavior
	  renderable: false,
	  rotation: 0,
	  scale: new _pixi2.default.Point(1, 1),
	  // can't set stage
	  visible: true
	...
	var SpriteComponentMixin = {
	  ...
	  applySpecificDisplayObjectProps: function applySpecificDisplayObjectProps(oldProps, newProps) {
	    this.transferDisplayObjectPropsByName(oldProps, newProps, {
	      'anchor': new _pixi2.default.Point(0, 0),
	      'tint': 0xFFFFFF,
	...
	var TilingSpriteComponentMixin = {
	  ...
	  applySpecificDisplayObjectProps: function applySpecificDisplayObjectProps(oldProps, newProps) {
	    this.transferDisplayObjectPropsByName(oldProps, newProps, {
	      'tileScale': new _pixi2.default.Point(1, 1),
	      'tilePosition': new _pixi2.default.Point(0, 0),
	      'tileScaleOffset': new _pixi2.default.Point(1, 1)
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactCompositeComponent = __webpack_require__(91);

	var _ReactCompositeComponent2 = _interopRequireDefault(_ReactCompositeComponent);

	var _ReactReconciler = __webpack_require__(92);

	var _ReactReconciler2 = _interopRequireDefault(_ReactReconciler);

	var _shouldUpdateReactComponent = __webpack_require__(93);
